...
retain parent "Tree2" MODEL "Tree2" MODELDESCRIPTION "Decision Tree (Interactive, Include ALL)" TARGETLABEL "";
...
retain parent "Tree" MODEL "Tree" MODELDESCRIPTION "Decision Tree (Auto, Exclude SS)" TARGETLABEL "";
